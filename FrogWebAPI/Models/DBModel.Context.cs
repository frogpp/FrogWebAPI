...
namespace FrogWebAPI.Models
{
    ...
    public partial class Database1Entities : DbContext
    {
        ...
        [DbFunction("Database1Entities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[Database1Entities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
